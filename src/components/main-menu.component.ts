...
@Component({
    ...
    <div class="fixed inset-0 z-[300] flex items-center justify-center animate-in fade-in duration-500 font-sans">
      ...
      <div class="relative w-full h-full lg:max-w-6xl lg:h-[85vh] flex flex-col lg:flex-row bg-slate-950/80 lg:border border-slate-800 lg:rounded-2xl shadow-2xl overflow-hidden backdrop-blur-3xl ring-1 ring-white/5">
         ...
         <!-- Content Area -->
         <main class="flex-1 overflow-y-auto relative z-10 menu-scrollbar p-4 lg:p-10 bg-gradient-to-b from-slate-900/30 to-transparent">
            @switch (activeTab()) {
                @case ('home') {
                  <app-menu-home-tab
  ...
  `,
    ...
    .menu-scrollbar::-webkit-scrollbar-track { background: transparent; }
    .menu-scrollbar::-webkit-scrollbar-thumb { background: #475569; border-radius: 3px; }
    .menu-scrollbar::-webkit-scrollbar-thumb:hover { background: #64748b; }
  `]
})
