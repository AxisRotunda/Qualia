...
@Component({
  ...
  standalone: true,
  template: `
    <div class="flex flex-col bg-slate-950/80 backdrop-blur-2xl border border-white/10 rounded-2xl overflow-hidden h-full shadow-2xl relative isolate transition-all">
