...
export const PROP_TEMPLATES: EntityTemplate[] = [
    { id: 'prop-column-ornate', label: 'Column (Marble)', category: 'prop', icon: 'view_column',
      ...
      mass: 0, physicsMaterial: 'rock', friction: 0.5, restitution: 0.1, tags: ['prop', 'static', 'interior'] },
    ...
    { id: 'prop-server-rack', label: 'Server Rack', category: 'prop', icon: 'dns',
      ...
      mass: 350, physicsMaterial: 'metal', friction: 0.6, restitution: 0.05, tags: ['prop', 'tech'] }, // Heavy electronics
    ...
    { id: 'prop-monitor-triple', label: 'Monitors (3x)', category: 'prop', icon: 'monitor',
      ...
      mass: 15, physicsMaterial: 'plastic', friction: 0.5, restitution: 0.1, tags: ['prop', 'tech'] },
    ...
    { id: 'prop-file-cabinet', label: 'File Cabinet', category: 'prop', icon: 'folder_open',
      ...
      mass: 80, physicsMaterial: 'metal', friction: 0.5, restitution: 0.1, tags: ['prop', 'furniture'] },
    ...
    { id: 'prop-table-map', label: 'War Room Table', category: 'prop', icon: 'table_view',
      ...
      mass: 400, physicsMaterial: 'metal', friction: 0.7, restitution: 0.1, tags: ['prop', 'furniture', 'tech'] },
    ...
    // Generic Props (HARD REALISM UPDATE)
    { id: 'prop-crate', label: 'Ind. Crate', category: 'prop', icon: 'package_2',
      ...
      mass: 150, physicsMaterial: 'wood', friction: 0.8, restitution: 0.05, tags: ['prop', 'dynamic', 'heavy'] }, 
    ...
    { id: 'prop-barrel', label: 'Steel Barrel', category: 'prop', icon: 'oil_barrel',
      ...
      mass: 200, physicsMaterial: 'metal', friction: 0.6, restitution: 0.1, tags: ['prop', 'dynamic', 'heavy'] }, 
    ...
    { id: 'prop-cinderblock', label: 'Cinderblock', category: 'prop', icon: 'bricks',
      ...
      mass: 16, physicsMaterial: 'concrete', friction: 0.95, restitution: 0.02, tags: ['prop', 'dynamic', 'debris'] },
    ...
    { id: 'prop-glass-block', label: 'Glass Cube', category: 'prop', icon: 'check_box_outline_blank',
      ...
      mass: 80, physicsMaterial: 'glass', friction: 0.3, restitution: 0.4, tags: ['prop', 'dynamic'] },

    { id: 'prop-ice-block', label: 'Ice Cube', category: 'prop', icon: 'icecream',
      geometry: 'box', size: new THREE.Vector3(2, 2, 2), materialId: 'mat-ice',
      mass: 60, physicsMaterial: 'ice', friction: 0.02, restitution: 0.1, tags: ['prop', 'dynamic', 'ice'] },
    ...
    { id: 'prop-sensor-unit', label: 'Sensor Unit', category: 'prop', icon: 'settings_input_antenna',
      ...
      mass: 25, physicsMaterial: 'metal', friction: 0.5, restitution: 0.2, tags: ['prop', 'dynamic'] },
];