...
export const INTERIOR_ASSETS: Record<string, AssetDef> = {
    ...
    'gen-desk-agency': complex(ctx => ctx.interior.generateDesk(), ['mat-desk-top', 'mat-cabinet-metal']),
    'gen-monitor-cluster': complex(ctx => ctx.interior.generateMonitorCluster(), ['mat-plastic-black', 'mat-screen-matrix']),
